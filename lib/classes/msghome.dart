    ...
    if(fimSemana == 1 || fimSemana == 2 ){
     ...
     switch (qtdDiasUteis) {
      case 1:
        ...
        break;
      case 2:
        msgDodia ="Fluxo de Caixa: ferramenta fundamental para aferir a saúde financeira e definir providências vitais para a empresa. O seu acompanhamento deve ser diário. ";
        msgDodiaSub ="Com a prática não demora mais do que o primeiro cafezinho do dia.";
        msgDodiaInfo = "";
        break;
      case 3:
        msgDodia ="Já providenciou o envio para a contabilidade das informações do mês passado? ...Peça que lhe mandem os DADOS BÁSICOS para que você possa atualizar este Aplicativo. ";
        msgDodiaSub = "Aliás, a qualidade destas informações será responsável por sua utilidade.";
        msgDodiaInfo = "";
        break;
      case 4:
        msgDodia ="Dizem que fazer caminhadas é bom para a saúde. Para os negócios também! ";
      ...
      case 5:
        ...
        break;
      case 6:
        msgDodia ="Você já lançou as informações do mês passado em DADOS BÁSICOS?  ";
        ...
        break;
      case 7:
        msgDodia ="Na hora de decidir prioridades é importante distinguir entre o que é realmente importante e o que é apenas impressionante.";
      ...
      case 9:
        ...
        break;
      case 10:
        msgDodia ="Você mantém em oferta produto pouco rentável porque é importante para a venda de outros? ";
        ...
        break;
      case 11:
        msgDodia ="Quando você oferece descontos 'impressionantes', desaponta quem comprou com o preço normal e desvaloriza os produtos. ";
        msgDodiaSub ="Já ouviu falar de 'cashback'? ...O cliente compra e você devolve parte do valor pago.";
        msgDodiaInfo = "";
        break;
      case 12:
        msgDodia ="Pesquise: você tem algum amigo que se enquadre no perfil do seu público-alvo? Peça para ele opinar sobre seu produto com menor venda. Por que ele acha que vende pouco? ";
        ...
        break;
      case 13:
        msgDodia ="Como está o desempenho do mês? As vendas estão dentro do previsto? O ticket médio também? E os custos? ";
      ...
      case 14:
        ...
        break;
      case 15:
        msgDodia = "Assim como os comandantes usam um 'checklist' antes de levantar voo, cada atividade principal da empresa deve ter seu checklist para assegurar que todos os procedimentos de rotinas necessárias sejam observados.";
        msgDodiaSub = "Pode crer, ajuda muito!";
        msgDodiaInfo = "";
        break;
      case 16:
        msgDodia ="Produtividade é o que justifica seus investimentos, despesas e custos fixos.";
        ...
        break;
      case 17:
        msgDodia ="Um tipo de praga que ataca o lucro da empresa é a ociosidade, ou seja: tudo que custa e não produz o que poderia (salas fechadas, pessoal e equipamentos subutilizados). ";
        msgDodiaSub = "Ou você aumenta sua utilização ou se desfaz.";
        msgDodiaInfo = "";
        break;
      case 18:
        msgDodia = "Já está preparado para o próximo mês? Dê uma lida em DIAGNÓSTICO e use o SIMULADOR para antever prioridades. ";
        msgDodiaSub ="Se for o caso, analise a VIABILIDADE DE AÇÃO PROMOCIONAL.";
        msgDodiaInfo = "";
        break;
      case 19:
        msgDodia ="Desperdício: torneira vazando, lâmpada acesa, ar condicionado funcionando sem necessidade, etc.";
      ...
      case 20:
        ...
        break;
      case 21:
        msgDodia ="Pense no relacionamento com seu público-alvo, clientes, fornecedores, prestadores de serviços.";
