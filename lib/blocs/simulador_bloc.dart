   ...
   // var fat =   double.parse(faturamentoConverido);
    ...
    switch (select) {
      case 'Quantidade clientes atendidos':
         print('Quantidade clientes atendidos');
