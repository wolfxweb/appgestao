...
class ListaDadosBasicosGestao extends StatefulWidget {
  const ListaDadosBasicosGestao({Key? key}) : super(key: key);

  @override
  _ListaDadosBasicosGestaoStateState createState() => _ListaDadosBasicosGestaoStateState();
}

class _ListaDadosBasicosGestaoStateState extends State<ListaDadosBasicosGestao> {
  var route = PushPage();
