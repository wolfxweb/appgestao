...
class TelaAjudaSimulador extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    var texto1;
    var texto2 ="Você pode selecionar um ou vários itens, indicando aumentos % ou diminuições %. Sempre que fizer isso observe a consequência em 'Margem resultante'.";
    var texto3 ="Caso queira rever o % atribuido em um determinado item, é só selecioná-lo novamente.";
